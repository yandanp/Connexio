...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            modules::pty::terminal_create_ssh,
            ...
            modules::ssh::ssh_build_command_args,
            modules::ssh::ssh_test_connection,
            modules::ssh::ssh_secret_set,
            modules::ssh::ssh_secret_get,
            modules::ssh::ssh_secret_delete,
            modules::ssh::ssh_known_hosts_list,
            ...
            modules::ssh::ssh_sftp_delete,
            modules::ssh::ssh_sftp_rename,
            modules::ssh::ssh_forget_openssh_host,
