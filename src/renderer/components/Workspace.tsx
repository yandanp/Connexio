			...
			<div className="flex items-center h-8 px-3 bg-connexio-bg-secondary border-b border-connexio-border gap-2">
				...
				<div className="ml-auto flex items-center gap-0.5 flex-shrink-0">
					...
					<button
						...
						type="button"
						aria-label="Toggle SSH Connections panel"
					>
						<Server size={12} />
					</button>
				</div>
					...
					>
						...
						<div className="flex items-center border-b border-connexio-border flex-shrink-0 overflow-x-auto">
							...
							<button
								...
								type="button"
								role="tab"
								aria-selected={sidePanelTab === "explorer"}
							...
							<button
								...
								type="button"
								role="tab"
								aria-selected={sidePanelTab === "source"}
							...
							<button
								...
								type="button"
								role="tab"
								aria-selected={sidePanelTab === "ssh"}
								aria-label="SSH Connections panel"
							>
								<Server size={10} />
								SSH
							</button>
