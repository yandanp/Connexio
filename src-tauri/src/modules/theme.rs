...
fn default_themes() -> Vec<AppTheme> {
    vec![
        AppTheme {
            ...
            colors: ThemeColors {
                bg_primary: "#090d14".to_string(),
                bg_secondary: "#101622".to_string(),
                bg_tertiary: "#172033".to_string(),
                border_color: "#263348".to_string(),
                accent_color: "#38bdf8".to_string(),
                accent_hover: "#0ea5e9".to_string(),
                text_primary: "#e5eefb".to_string(),
                text_secondary: "#9fb1ca".to_string(),
                text_muted: "#65758d".to_string(),
            },
            terminal: TerminalThemeColors {
                background: "#090d14".to_string(),
                foreground: "#e5eefb".to_string(),
                cursor: "#38bdf8".to_string(),
                cursor_accent: "#090d14".to_string(),
                selection_background: "#38bdf840".to_string(),
        ...
        AppTheme {
            ...
            terminal: TerminalThemeColors {
                ...
                cursor: "#0ea5e9".to_string(),
                cursor_accent: "#ffffff".to_string(),
                selection_background: "#0ea5e930".to_string(),
